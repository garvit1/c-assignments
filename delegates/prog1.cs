...
namespace EmployeeManagement
{
    ...
    class EmployeeManagementMain
    {
        ...
        static void Main()
        {
            ...
            obj1 = new Manager("Garvit", "Khandelwal", "Manager", 1000000);
            obj1.CalculateSalary();
            EmployeeDelegate emp = new EmployeeDelegate(obj1.DisplayEmployeeDetails);
            emp();

            obj2 = new MarketingExecutive("ABC", "JAMES", "Marketing Executive", 200000, 10);
